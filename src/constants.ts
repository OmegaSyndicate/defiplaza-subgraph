...
export let DEX_TOKENS: DexToken[] = [
	new DexToken(Address.fromString("0x0000000000000000000000000000000000000000"), "ETH", BI_18, BigDecimal.fromString("10.8")),
	...
	new DexToken(Address.fromString(DFP2_ADDRESS), "DFP2", BI_18, BigDecimal.fromString("3600000")),

	// Swapped out token. Left in for history preservation. Will show up with tokenAmount 0 in current responses.
...
export let ETHEREUM: DexToken = DexToken.getToken(Address.fromString(ADDRESS_ZERO))
